...
@section('content')
<form action="{{route('customer.store')}}" method="post" target="_blank">
    ...
    <div class="mb-3">
        ...
        <input name="full_name" type="text" class="form-control" value="Customer Name">
    </div>

    <div class="mb-3">
        <label class="form-label">phone_number</label>
        <input name="phone_number" type="text" class="form-control" value="0100000000000">
    </div>
    ...
    <div class="mb-3">
        ...
        <input name="email" type="email" class="form-control" value="customer@email.com">
    </div>
